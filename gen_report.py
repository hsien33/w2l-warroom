...
TG_TOKEN=env("TG_BOT_TOKEN"); TG_CHAT=env("TG_CHAT_ID")   # Telegram 推播（免費無上限；LINE 已退場）
HERE=os.path.dirname(os.path.abspath(__file__))
URL="https://hsien33.github.io/w2l-warroom/report.html"
ROOM="https://hsien33.github.io/w2l-warroom/"
DECIDE="https://hsien33.github.io/w2l-warroom/decide.html"
...
<hr>
<p style="text-align:center;margin:18px 0"><a href="{DECIDE}" style="display:inline-block;background:linear-gradient(160deg,#1b160d,#0e0b06);color:#f3ead6;text-decoration:none;font-weight:800;border-radius:30px;padding:14px 30px;font-size:17px">🎛️ 去裁示駕駛艙（看成品＋裁決＋送出開工）</a></p>
<p>📊 即時戰情室：<a href="{ROOM}">{ROOM}</a></p>
"""
